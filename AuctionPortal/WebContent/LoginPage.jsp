...
<html>
	...
	<h2>Admin Login</h2>
		...
		<br>
		If not a registered Admin, please Sign up
	...
	<h2>Franchise Login</h2>
		...
		<br>
		If not a registered Franchise, please Sign up
		<form action="<%=request.getContextPath()%>/FranchiseSignUpServlet" method="post">
